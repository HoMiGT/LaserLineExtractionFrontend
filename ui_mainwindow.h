...
public:
    ...
    QLabel *label_6;
    QLCDNumber *lcdNumber_checkSumCount;
    QMenuBar *menubar;
    QMenu *menu_file;
    QMenu *menu_help;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        sizePolicy2.setHeightForWidth(lcdNumber_success->sizePolicy().hasHeightForWidth());
        lcdNumber_success->setSizePolicy(sizePolicy2);
        ...
        sizePolicy2.setHeightForWidth(lcdNumber_fail->sizePolicy().hasHeightForWidth());
        lcdNumber_fail->setSizePolicy(sizePolicy2);
        ...
        label_6 = new QLabel(groupBox_taskStates);
        label_6->setObjectName("label_6");

        formLayout->setWidget(8, QFormLayout::LabelRole, label_6);

        lcdNumber_checkSumCount = new QLCDNumber(groupBox_taskStates);
        lcdNumber_checkSumCount->setObjectName("lcdNumber_checkSumCount");
        lcdNumber_checkSumCount->setMinimumSize(QSize(0, 40));
        lcdNumber_checkSumCount->setMaximumSize(QSize(16777215, 40));
        lcdNumber_checkSumCount->setFont(font2);
        lcdNumber_checkSumCount->setFrameShadow(QFrame::Sunken);
        lcdNumber_checkSumCount->setDigitCount(20);
        lcdNumber_checkSumCount->setSegmentStyle(QLCDNumber::Flat);

        formLayout->setWidget(8, QFormLayout::FieldRole, lcdNumber_checkSumCount);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_6->setText(QCoreApplication::translate("MainWindow", "\346\243\200\346\265\213\346\200\273\346\225\260\351\207\217:", nullptr));
